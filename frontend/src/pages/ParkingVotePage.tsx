...
export default function ParkingVotePage() {
  ...
  // Piedmont is a separate incorporated city entirely surrounded by Oakland.
  // oakland_boundary.geojson carries it as an interior hole (it is generated by
  // data_pipeline/scripts/build_oakland_boundary.py, which keeps that hole on purpose), so the
  // outline below already excludes it. This ring is only for the dashed label outline.
      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        >
          ...
          {cityBoundary && (() => {
            ...
            // Leaflet renders positions[i][0] as a polygon's outer ring and positions[i][1..]
            // as holes in it, which is exactly the GeoJSON ring order, so the file's Piedmont
            // hole comes through untouched.
            return (
              <Polygon
                positions={polys}
